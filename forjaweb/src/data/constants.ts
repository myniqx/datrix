...
export const FORJA_PACKAGES = [
  {
    name: "@forja/core",
    description: "Schema engine, query executor, migration system, and plugin runtime.",
    npm: "https://www.npmjs.com/package/@forja/core",
  },
  {
    name: "@forja/types",
    description: "Shared TypeScript types — ForjaEntry, QueryObject, adapters, plugins.",
    npm: "https://www.npmjs.com/package/@forja/types",
  },
  {
    name: "@forja/adapter-postgres",
    description: "PostgreSQL adapter with full query translation and relation support.",
  ...
  },
  {
    ...
    description: "MongoDB adapter with full CRUD, relation population, and migration support.",
  ...
  {
    name: "@forja/api",
    description: "HTTP layer with REST endpoints, JWT/session auth, and query parsing.",
    npm: "https://www.npmjs.com/package/@forja/api",
  },
  {
    name: "@forja/cli",
    description: "CLI for migrations, type generation, and resource scaffolding.",
