...
export const FUNCTION_DEFINITIONS: Record<string, FunctionDefinition> = {
  ...
  findById: {
    ...
    description: "Shorthand for findOne with where: { id }. Returns null if not found.",
  ...
  update: {
    ...
    description: "Updates a single record by ID and returns it. Throws RECORD_NOT_FOUND if the ID does not exist.",
  ...
  delete: {
    ...
    description: "Deletes a single record by ID and returns it. Throws RECORD_NOT_FOUND if the ID does not exist.",
  ...
  getSchema: {
    ...
    description: "Returns a single schema by name, or undefined if not registered.",
  ...
  isInitialized: {
    ...
    description: "Returns true if forja has been initialized. Safe to call before initialization.",
    docsPath: "/docs/core/interfaces#isinitialized",
  },

  getConfig: {
    signature: `getConfig(): ForjaConfig`,
    description: "Returns the active configuration object. Throws if called before initialization.",
  ...
  shutdown: {
    ...
    description: "Destroys all plugins, closes the database connection, and resets the instance.",
  ...
  beginMigrate: {
    ...
    description: "Used internally by the Forja CLI. Compares current schemas against the live database and returns a MigrationSession.",
  ...
  defineConfig: {
    ...
    description: "Define Forja configuration. Returns a function that when called, returns an initialized Forja instance.",
    docsPath: "/docs/core/getting-started#defineconfig",
  },

  defineSchema: {
    signature: `defineSchema(\n  definition: SchemaDefinition,\n): SchemaDefinition`,
    description: "Define a schema. Pass the result to schemas[] in defineConfig().",
