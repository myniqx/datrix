...
export const TYPE_DEFINITIONS: Record<string, TypeDefinition> = {
  ...
  "ComparisonOperators": {
    ...
    description: "Field-level comparison operators for WhereClause. Operators are type-aware — $gt/$lt are only valid for number/Date fields, $like/$contains only for strings.",
  ...
  "PopulateOptions": {
    ...
    description: "Per-relation populate options. Used as the value in an object-form PopulateClause.",
  ...
  "SchemaDefinition": {
    ...
    description: "Defines a database table's structure, constraints, and access rules. Pass the result of defineSchema() to schemas[] in defineConfig().",
    docsPath: "/docs/core/types#schemadefinition",
  },
  "FieldDefinition": {
    group: "Schema",
    signature: `type FieldDefinition =\n  | StringField\n  | NumberField\n  | BooleanField\n  | DateField\n  | JsonField\n  | EnumField\n  | ArrayField\n  | RelationField\n  | FileField`,
    description: "Discriminated union of all field type interfaces. The type property on each determines which options are available.",
    docsPath: "/docs/core/types#fielddefinition",
  },
  "StringField": {
    group: "Schema",
    signature: `interface StringField {\n  type:          "string"\n  required?:     boolean\n  default?:      string\n  unique?:       boolean\n  minLength?:    number\n  maxLength?:    number\n  pattern?:      RegExp\n  validator?:    (value: string) => true | string\n  errorMessage?: string\n  description?:  string\n  permission?:   FieldPermission\n}`,
    description: "String field definition. Use minLength/maxLength for length constraints, pattern for regex validation, validator for custom logic.",
    docsPath: "/docs/core/types#stringfield",
  },
  "NumberField": {
    group: "Schema",
    signature: `interface NumberField {\n  type:           "number"\n  required?:      boolean\n  default?:       number\n  unique?:        boolean\n  min?:           number\n  max?:           number\n  integer?:       boolean\n  autoIncrement?: boolean\n  validator?:     (value: number) => true | string\n  description?:   string\n  permission?:    FieldPermission\n}`,
    description: "Number field definition. Set integer: true to disallow decimals. autoIncrement is typically only used for the primary key.",
  ...
  "JsonField": {
    ...
    description: "JSON field definition. Stored as a JSON column. Optionally validated against a JSON schema.",
    docsPath: "/docs/core/types#jsonfield",
  },
  "EnumField": {
    group: "Schema",
    signature: `interface EnumField {\n  type:         "enum"\n  required?:    boolean\n  default?:     string\n  values:       readonly string[]  // allowed values\n  description?: string\n  permission?:  FieldPermission\n}`,
    description: "Enum field definition. values defines the complete set of allowed string literals.",
  ...
  "ArrayField": {
    ...
    description: "Array field definition. items defines the type of each element — can be any FieldDefinition including nested objects.",
  ...
  "RelationField": {
    ...
    description: "Relation field definition. kind determines the cardinality. For manyToMany, a junction table is auto-generated if through is omitted.",
  ...
  "FileField": {
    ...
    description: "File field definition. Requires the upload plugin to be configured.",
  ...
  "SchemaPermission": {
    ...
    description: "Schema-level access control. Each action accepts true, false, a role array, a function, or a mixed array of roles and functions.",
    docsPath: "/docs/core/types#schemapermission",
  },
  "FieldPermission": {
    group: "Permissions",
    signature: `interface FieldPermission {\n  read?:  PermissionValue\n  write?: PermissionValue\n}`,
    description: "Field-level access control. read: if denied, field is stripped from the response. write: if denied, returns 403.",
  ...
  "PermissionValue": {
    ...
    description: "Defines who can perform an action. true = everyone, false = nobody, string array = specific roles, function = custom logic.",
    docsPath: "/docs/core/types#permissionvalue",
  },
  "PermissionFn": {
    group: "Permissions",
    signature: `type PermissionFn = (ctx: PermissionContext) => boolean | Promise<boolean>`,
    description: "Custom permission function. Receives the full request context and returns true to allow, false to deny.",
  ...
  "PermissionContext": {
    ...
    description: "Context passed to permission functions. user is undefined for unauthenticated requests.",
  ...
  "DatabaseAdapter": {
    ...
    description: "Interface all database adapters must implement. Passed as adapter in defineConfig().",
  ...
  "AlterOperation": {
    ...
    description: "Discriminated union of column-level DDL operations used in alterTable(). MetaField variants are for internal Forja-managed columns.",
  ...
  "Transaction": {
    ...
    description: "Wraps a database transaction. Supports query execution and schema operations atomically. Returned by DatabaseAdapter.beginTransaction().",
  ...
  "PluginContext": {
    ...
    description: "Context provided to a plugin's init() method. Gives access to the adapter, schema registry, and configuration.",
    docsPath: "/docs/core/types#plugincontext",
  },
  "QueryContext": {
    group: "Plugin",
    signature: `interface QueryContext {\n  readonly action:   QueryAction\n  readonly schema:   SchemaDefinition\n  readonly metadata: Record<string, unknown>\n  user?:             AuthUser\n}`,
    description: "Context passed to onBeforeQuery / onAfterQuery plugin hooks. Contains the action being performed and the schema being queried.",
  ...
  "SchemaExtensionContext": {
    ...
    description: "Context passed to a plugin's extendSchemas() hook. Provides helpers to extend all or a subset of schemas.",
  ...
  "SchemaExtension": {
    ...
    description: "Describes fields and indexes to add, remove, or modify on an existing schema. Returned from extendSchemas().",
  ...
  "QueryAction": {
    ...
    description: "The CRUD operation being performed. Available in QueryContext inside plugin hooks.",
  ...
  "SchemaRegistry": {
    ...
    description: "Registry that holds all registered schemas. Returned by getSchemas().",
  ...
  "MigrationSession": {
    ...
    description: "Returned by beginMigrate(). Represents a diff session between current schemas and database state.",
  ...
  "AmbiguousChange": {
    ...
    description: "A schema change that Forja cannot resolve automatically — typically a field rename vs. drop+add. Must be resolved with MigrationSession.resolveAmbiguous() before applying.",
  ...
  "AmbiguousActionType": {
    ...
    description: "Resolution for an ambiguous schema change. Passed to MigrationSession.resolveAmbiguous().",
  ...
  "Migration": {
    ...
    description: "A single migration unit — metadata plus the list of DDL operations to execute.",
    docsPath: "/docs/core/types#migration",
  },
  "MigrationMetadata": {
    group: "Migration",
    signature: `interface MigrationMetadata {\n  readonly name:         string\n  readonly version:      string\n  readonly timestamp:    number\n  readonly description?: string\n  readonly author?:      string\n}`,
    description: "Descriptive metadata attached to a migration. version is used to track which migrations have been applied.",
  ...
  "MigrationOperation": {
    ...
    description: "Discriminated union of all DDL operations a migration can contain.",
  ...
  "MigrationPlan": {
    ...
    description: "The list of migrations to execute, as returned by MigrationSession.getPlan(). target is undefined when targeting the latest version.",
    docsPath: "/docs/core/types#migrationplan",
  },
  "MigrationExecutionResult": {
    group: "Migration",
    signature: `interface MigrationExecutionResult {\n  readonly migration:     Migration\n  readonly status:        MigrationStatus\n  readonly executionTime: number\n  readonly error?:        Error\n  readonly warnings?:     string[]\n}`,
    description: "Result of a single migration execution. status is one of 'pending' | 'running' | 'completed' | 'failed'.",
  ...
  "MigrationConfig": {
    ...
    description: "Controls migration behavior. auto defaults to false in production.",
  ...
  "DevConfig": {
    ...
    description: "Development mode options. All options default to false in production.",
