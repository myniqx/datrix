...
import { FORJA_VERSION, FORJA_GITHUB_URL, FORJA_NPM_INSTALL } from "@/data/constants"
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden lg:grid lg:grid-cols-2 lg:items-center">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center lg:min-h-0 lg:justify-start">
        ...
        >
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-foreground lg:text-6xl">
            Database layer for<br />
            TypeScript backends
          </h1>

          <p className="text-base text-foreground/80 leading-relaxed lg:text-lg">
            Define your schema once. Query with full type safety,
            swap databases freely, and extend with plugins —
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button asChild size="lg" variant="outline">
              <a href={FORJA_GITHUB_URL} target="_blank" rel="noopener noreferrer">View on GitHub</a>
            </Button>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2">
        <Button asChild variant="ghost" size="sm" className="flex flex-col gap-1 h-auto py-2 text-foreground/80 hover:text-foreground animate-bounce">
          <a href="#showcase">
