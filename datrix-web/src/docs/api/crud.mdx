...
| `QUERY`  | `/api/:schema`     | List records with a JSON query body — see below (New in 0.2.0) |
| `POST`   | `/api/:schema/query` | Alias for `QUERY`, for runtimes that don't support the method (New in 0.2.0) |
