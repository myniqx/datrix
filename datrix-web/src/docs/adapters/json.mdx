...
<ExternalLink
	href="https://myniqx.dev/en/blog/convincing-a-file-system-to-behave-like-a-database-inside-adapter-json"
	title="Convincing a File System to Behave Like a Database: Inside adapter-json"
>
	A deep dive into the design decisions behind this adapter (locking,
	transactions, atomic writes, and the trade-offs of treating JSON files as a
	database).
</ExternalLink>
