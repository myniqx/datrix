...
export const meta: MetaFunction = () => [
	...
	{
		property: "og:title",
		content: "Datrix — Schema-driven database layer for TypeScript",
	},
	{
	...
	{ property: "og:url", content: "https://datrix.dev/" },
	{ tagName: "link", rel: "canonical", href: "https://datrix.dev/" },
];
				...
				<Container>
					<div className="mb-12 flex flex-col gap-4">
						...
						<p className="text-base text-foreground/80">
							...
							Datrix handles relations, filters, and nested queries.
						</p>
					</div>
					<Playground />
				</Container>
