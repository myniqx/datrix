...
describe('QueryParser - Happy Path', () => {
  ...
  describe('Pagination', () => {
    it('should parse limit and offset directly', () => {
      const limitOffsetParams: RawQueryParams = parserTestData.paginationParams.limitOffset;
    ...
    it('should parse page and pageSize', () => {
      const pagePageSizeParams: RawQueryParams = parserTestData.paginationParams.pagePageSize;
    ...
    it('should use default pageSize when page is provided without pageSize', () => {
      const pageOnlyParams: RawQueryParams = parserTestData.paginationParams.pageOnly;
    ...
    it('should handle pageSize without page', () => {
      const pageSizeOnlyParams: RawQueryParams = parserTestData.paginationParams.pageSizeOnly;
    ...
    it('should handle large page numbers', () => {
      const largePageParams: RawQueryParams = parserTestData.paginationParams.largePage;
    ...
    it('should respect custom defaultPageSize option', () => {
      ...
      const parsedQuery = expectSuccessData(parseQuery(emptyParams, customOptions));
  ...
  describe('Sorting', () => {
    ...
    it('should parse single field descending sort', () => {
      const singleDescParams: RawQueryParams = parserTestData.sortParams.singleDesc;

      const parsedQuery = expectSuccessData(parseQuery(singleDescParams));

      expect(parsedQuery.orderBy).toEqual([{ field: 'createdAt', direction: 'desc' }]);
    });
    ...
    it('should parse sort with underscores', () => {
      const underscoreParams: RawQueryParams = parserTestData.sortParams.withUnderscore;
  ...
  describe('Determinism', () => {
    ...
    it('should return same result regardless of input mutation', () => {
      ...
      const secondParse = expectSuccessData(parseQuery({ fields: 'id,name', limit: '10' }));
