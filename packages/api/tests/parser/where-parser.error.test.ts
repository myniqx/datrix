...
describe('WhereParser - Error Path', () => {
  describe('Security: SQL Injection', () => {
    it('should reject SQL injection in field name', () => {
      const sqlInjectionFieldParams: RawQueryParams = parserTestData.invalidWhereConditions.sqlInjectionField;
    ...
    it('should safely handle SQL injection in value', () => {
      ...
      const sqlInjectionValueParams: RawQueryParams = parserTestData.invalidWhereConditions.sqlInjectionValue;
  ...
  describe('Security: XSS Protection', () => {
    it('should reject XSS in field name', () => {
      const xssFieldParams: RawQueryParams = parserTestData.invalidWhereConditions.xssInField;
    ...
    it('should safely handle XSS in value', () => {
      ...
      const xssValueParams: RawQueryParams = parserTestData.invalidWhereConditions.xssInValue;
  ...
  describe('Security: Path Traversal', () => {
    it('should reject path traversal in field name', () => {
      const pathTraversalParams: RawQueryParams = parserTestData.invalidWhereConditions.pathTraversalField;
  ...
  describe('Security: Command Injection', () => {
    it('should safely handle command injection in value', () => {
      const commandInjectionParams: RawQueryParams = parserTestData.invalidWhereConditions.commandInjectionValue;
  ...
  describe('Security: Null Byte Injection', () => {
    it('should reject null byte in field name', () => {
      const nullByteFieldParams: RawQueryParams = parserTestData.invalidWhereConditions.nullByteField;
  ...
  describe('Invalid operators', () => {
    it('should reject unknown operator', () => {
      const invalidOperatorParams: RawQueryParams = parserTestData.invalidWhereConditions.invalidOperator;
  ...
  describe('Boundary Safety', () => {
    it('should reject excessively long field names', () => {
      const longFieldParams: RawQueryParams = parserTestData.invalidWhereConditions.excessivelyLongField;
    ...
    it('should reject excessively long values', () => {
      const longValueParams: RawQueryParams = parserTestData.invalidWhereConditions.excessivelyLongValue;
  ...
  describe('Explicit Failure Messages', () => {
    it('should return consistent error structure', () => {
      const invalidParams: RawQueryParams = parserTestData.invalidWhereConditions.invalidOperator;
