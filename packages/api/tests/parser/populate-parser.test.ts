...
describe("PopulateParser - Happy Path", () => {
	...
	describe("Simple string format", () => {
		...
		it.fails("should parse relations with underscores", () => {
			...
			const parsedPopulate = expectSuccessData(
				parsePopulate(underscoreRelations),
			);
		...
		it("should handle array format", () => {
			...
			const parsedPopulate = expectSuccessData(
				parsePopulate(arrayFormatParams),
			);
	...
	describe("Nested populate", () => {
		it("should parse simple nested populate", () => {
			...
			const parsedPopulate = expectSuccessData(
				parsePopulate(simpleNestedParams),
			);
		...
		it("should parse deep nested populate with fields and populate", () => {
			const deepNestedParams: RawQueryParams =
				parserTestData.nestedPopulate.deep;
	...
	describe("Max depth enforcement", () => {
		it("should allow populate within max depth (default 5)", () => {
			const depth5Params: RawQueryParams =
				parserTestData.maxDepthPopulate.depth5;
		...
		it("should allow populate up to custom max depth", () => {
			const depth2Params: RawQueryParams =
				parserTestData.maxDepthPopulate.depth2;
		...
		it("should allow depth 1 populate", () => {
			const depth1Params: RawQueryParams =
				parserTestData.maxDepthPopulate.depth1;
