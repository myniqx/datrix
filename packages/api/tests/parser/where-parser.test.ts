...
describe('WhereParser - Happy Path', () => {
  ...
  describe('Simple equality', () => {
    it('should parse single field equality', () => {
      const singleFieldParams: RawQueryParams = parserTestData.simpleWhereConditions.singleField;
    ...
    it('should parse multiple field equality', () => {
      const multipleFieldsParams: RawQueryParams = parserTestData.simpleWhereConditions.multipleFields;
  ...
  describe('Type coercion', () => {
    it('should coerce string numbers to actual numbers', () => {
      const numberFieldParams: RawQueryParams = parserTestData.simpleWhereConditions.numberField;
    ...
    it('should coerce string "true" to boolean true', () => {
      const booleanFieldParams: RawQueryParams = parserTestData.simpleWhereConditions.booleanField;
    ...
    it('should coerce string "null" to null', () => {
      const nullFieldParams: RawQueryParams = parserTestData.simpleWhereConditions.nullField;
  ...
  describe('Comparison operators', () => {
    it('should parse $gt operator', () => {
      const gtParams: RawQueryParams = parserTestData.comparisonOperators.greaterThan;
    ...
    it('should parse $gte operator', () => {
      const gteParams: RawQueryParams = parserTestData.comparisonOperators.greaterThanOrEqual;
    ...
    it('should parse $lte operator', () => {
      const lteParams: RawQueryParams = parserTestData.comparisonOperators.lessThanOrEqual;
    ...
    it('should combine multiple operators on same field', () => {
      const combinedParams: RawQueryParams = parserTestData.comparisonOperators.combined;
  ...
  describe('String operators', () => {
    it('should parse $contains operator', () => {
      const containsParams: RawQueryParams = parserTestData.stringOperators.contains;
    ...
    it('should parse $startsWith operator', () => {
      const startsWithParams: RawQueryParams = parserTestData.stringOperators.startsWith;
    ...
    it('should parse $endsWith operator', () => {
      const endsWithParams: RawQueryParams = parserTestData.stringOperators.endsWith;
  ...
  describe('Array operators', () => {
    ...
    it('should parse $in operator with numeric strings', () => {
      const inNumberParams: RawQueryParams = parserTestData.arrayOperators.inWithNumbers;
  ...
  describe('Logical operators', () => {
    it('should parse simple $or operator', () => {
      const simpleOrParams: RawQueryParams = parserTestData.logicalOperators.simpleOr;
    ...
    it('should parse simple $and operator', () => {
      const simpleAndParams: RawQueryParams = parserTestData.logicalOperators.simpleAnd;
    ...
    it('should parse nested logical operators', () => {
      const nestedOrParams: RawQueryParams = parserTestData.logicalOperators.nestedOr;
  ...
  describe('Determinism', () => {
    ...
    it('should return same result regardless of input object mutation', () => {
      ...
      const secondParse = expectSuccessData(parseWhere({ 'where[status]': 'active' }));
