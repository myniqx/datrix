...
describe("WhereParser - Happy Path", () => {
	...
	describe("Comparison operators", () => {
		...
		it.fails("should parse $lt operator", () => {
			const ltParams: RawQueryParams =
				parserTestData.comparisonOperators.lessThan;
		...
		it("should parse $ne operator", () => {
			const neParams: RawQueryParams =
				parserTestData.comparisonOperators.notEqual;
	...
	describe("Input Immutability", () => {
		...
		it("should not mutate input arrays", () => {
			...
			const arrayParams: RawQueryParams = {
				"where[status][$in]": originalArray,
			};
