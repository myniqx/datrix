...
describe("Pagination Integration Tests", () => {
  ...
  describe("Pagination with Sorting", () => {
    ...
    it("should paginate sorted results correctly", async () => {
      ...
      await forja.create("user", { name: "Charlie", email: "c@example.com", age: 30 });
      await forja.create("user", { name: "Alice", email: "a@example.com", age: 25 });
      await forja.create("user", { name: "Bob", email: "b@example.com", age: 20 });
  ...
  describe("Combined Scenarios", () => {
    ...
    it("should handle pagination + filtering + sorting together", async () => {
      // Create mixed data
      await forja.create("user", { name: "Alice", email: "a@example.com", age: 30 });
      await forja.create("user", { name: "Bob", email: "b@example.com", age: 20 });
      await forja.create("user", { name: "Charlie", email: "c@example.com", age: 35 });
      await forja.create("user", { name: "David", email: "d@example.com", age: 25 });
      await forja.create("user", { name: "Eve", email: "e@example.com", age: 40 });
      await forja.create("user", { name: "Frank", email: "f@example.com", age: 28 });
