...
export function validateField<T = unknown>(
  ...
  switch (field.type) {
    case 'string':
      return validateString(value, field as StringField, fieldName) as FieldValidationResult<T>;
    case 'number':
      return validateNumber(value, field as NumberField, fieldName) as FieldValidationResult<T>;
    case 'boolean':
      return validateBoolean(value, fieldName) as FieldValidationResult<T>;
    case 'date':
      return validateDate(value, field as DateField, fieldName) as FieldValidationResult<T>;
    case 'enum':
