...
import { createTestData, sampleSchemas, validData } from '../../../types/src/test/fixtures';
...
describe('SchemaValidator - Happy Path', () => {
  describe('validateSchema - Basic Validation', () => {
    it('should validate valid user data', () => {
      const validationResult = validateSchema(validData.user, sampleSchemas.userSchema);
    ...
    it('should validate valid post data', () => {
      const validationResult = validateSchema(validData.post, sampleSchemas.postSchema);
    ...
    it('should validate valid profile data', () => {
      const validationResult = validateSchema(validData.profile, sampleSchemas.profileSchema);
  ...
  describe('validateSchema - Required Fields', () => {
    it('should pass when only required fields are provided', () => {
      ...
      const validationResult = validateSchema(minimalUserData, sampleSchemas.userSchema);
    ...
    it('should pass when optional fields are omitted', () => {
      ...
      const validationResult = validateSchema(userWithoutOptionalAge, sampleSchemas.userSchema);
  ...
  describe('validatePartial - Update Validation', () => {
    it('should validate partial data without requiring all fields', () => {
      ...
      const validationResult = validatePartial(partialNameUpdate, sampleSchemas.userSchema);
    ...
    it('should allow updating single field', () => {
      ...
      const validationResult = validatePartial(partialAgeUpdate, sampleSchemas.userSchema);
    ...
    it('should allow empty object (no updates)', () => {
      const emptyUpdate = {};
      const validationResult = validatePartial(emptyUpdate, sampleSchemas.userSchema);
  ...
  describe('validateMany - Array Validation', () => {
    it('should validate array of valid data', () => {
      ...
      const validationResult = validateMany(multipleUsers, sampleSchemas.userSchema);
    ...
    it('should validate empty array', () => {
      ...
      const validationResult = validateMany(emptyArray, sampleSchemas.userSchema);
    ...
    it('should validate large arrays', () => {
      ...
      const validationResult = validateMany(largeUserArray, sampleSchemas.userSchema);
  ...
  describe('isValid - Boolean Check', () => {
    ...
    it('should respect options', () => {
      ...
      const validNonStrict = isValid(userWithExtraField, sampleSchemas.userSchema, {
        strict: false,
      });
  ...
  describe('validateOrThrow - Throws on Error', () => {
    it('should return data for valid input', () => {
      const validatedUser = validateOrThrow(validData.user, sampleSchemas.userSchema);
  ...
  describe('assertSchema - Type Assertion', () => {
    ...
    it('should narrow type after successful assertion', () => {
      const unknownUserData: unknown = validData.user;
      assertSchema<typeof validData.user>(unknownUserData, sampleSchemas.userSchema);
  ...
  describe('Edge Cases', () => {
    ...
    it('should validate nested object structures', () => {
      ...
      const validationResult = validateSchema(userWithTimestamp, sampleSchemas.userSchema);
