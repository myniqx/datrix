...
import { FieldDefinition } from "../../src/types/core";
...
export const parserTestData = {
	...
	maxDepthPopulate: {
		...
		depth5: {
			"populate[a][populate][b][populate][c][populate][d][populate][e]": "*",
		},
		depth6: {
...
export const createTestData: {
	...
	profile: (
		overrides?: Partial<typeof validData.profile>,
	) => typeof validData.profile;
	expressRequest: (
		overrides?: Partial<typeof apiContextData.validExpressRequest>,
	) => typeof apiContextData.validExpressRequest;
