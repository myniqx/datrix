...
describe('Core - Schema Registry - Error Path', () => {
  ...
  describe('Registration', () => {
    it('should prevent duplicate registration by default', () => {
      ...
      const duplicateRegistrationResult = strictSchemaRegistry.register(duplicateSchema);
    ...
    it('should reject invalid schema in strict mode', () => {
      ...
      const validationResult = strictSchemaRegistry.register(invalidSchemaWithEmptyName);
  ...
  describe('Locking', () => {
    it('should prevent modifications when locked', () => {
      ...
      const lockedRegistrationResult = strictSchemaRegistry.register(testSchema);
  ...
  describe('Relations', () => {
    it('should validate relation targets', () => {
      ...
      const registrationResult = strictSchemaRegistry.registerMany([postSchemaWithMissingRelation]);
