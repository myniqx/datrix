...
describe('MySQL Types', () => {
  ...
  describe('toMySQLValue', () => {
    ...
    describe('File conversion', () => {
      it('should convert file paths to strings', () => {
        expect(toMySQLValue('/path/to/file.jpg', 'file')).toBe('/path/to/file.jpg');
      });
  ...
  describe('parseConnectionString', () => {
    it('should parse basic connection string', () => {
      const result = parseConnectionString('mysql://user:password@localhost:3306/mydb');
    ...
    it('should use default port 3306 when not specified', () => {
      const result = parseConnectionString('mysql://user:password@localhost/mydb');
    ...
    it('should decode URL-encoded credentials', () => {
      const result = parseConnectionString('mysql://user%40domain:pass%23word@localhost/mydb');
    ...
    it('should parse ssl parameter', () => {
      const result = parseConnectionString('mysql://user:pass@localhost/mydb?ssl=true');

      expect(result['ssl']).toBe(true);
    });

    it('should parse connectTimeout parameter', () => {
      const result = parseConnectionString('mysql://user:pass@localhost/mydb?connectTimeout=5000');

      expect(result['connectTimeout']).toBe(5000);
    });

    it('should parse timezone parameter', () => {
      const result = parseConnectionString('mysql://user:pass@localhost/mydb?timezone=UTC');
